...
\courseCycle{XXX}   % \courseCycle{1} or \courseCycle{2}
\courseCode{XX100X} % fill in your course code
\courseCredits{XXX} % typically: \courseCredits{15.0} or \courseCredits{30.0}

% Fill in your program code 
\programcode{TXXXX}         % or \programcode{CXXXX}
\degreeName{*****Unknown degree*****} % \degreeName{Bachelors degree} or \degreeName{Degree of Master of Science in Engineering}
